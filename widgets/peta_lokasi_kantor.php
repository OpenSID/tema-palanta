		...
		<div id="collapse2" class="panel-collapse collapse">
			<div class="panelopen">
				<table width="100%" class="tableagenda">
					...
					<tr>
						<td><?=ucwords($this->setting->sebutan_desa)." "?></td><td width="20px">:</td><td><?=$desa['nama_desa']?></td>
					</tr>
					<tr>
						<td><?=ucwords($this->setting->sebutan_kecamatan)?></td><td width="20px">:</td><td><?=$desa['nama_kecamatan']?></td>
					</tr>
					<tr>
						<td><?=ucwords($this->setting->sebutan_kabupaten)?></td><td width="20px">:</td><td><?=$desa['nama_kabupaten']?></td>
					</tr>
					<tr>
