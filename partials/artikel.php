		...
		<div class="box-def-inner">
			<div class="artike-page">
				...
				<div class="artikel-meta" style="margin-bottom:10px;">
					<div class="meta-item l-flex"><i class="fa fa-calendar"></i><p><?= tgl_indo2($single_artikel['tgl_upload']) ?></p></div>
					<div class="meta-item l-flex"><i class="fa fa-user"></i><p><?= $single_artikel['owner'] ?></p></div>
					<div class="meta-item l-flex"><i class="fa fa-eye"></i><p><?= hit($single_artikel['hit']) ?> dibaca</p></div>
				</div>
